...
This assumes you have successfully booted your machine with the [Arch Linux ISO file](https://archlinux.org/download/).

If this is not the case, refer to [the previous steps](ArchLinuxInstallation.md).

## Step 1: Making sure things work
